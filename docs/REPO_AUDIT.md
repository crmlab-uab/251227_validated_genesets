 ...
 - `genesets/sources/kinases/201006_composite_kinases_curated.csv` — curated kinases composite (539 genes)
 - `genesets/sources/kinases/manning_2002_TableS1.csv` — Manning Table S1 (raw)
 ...
 1. Keep the canonical copies under `genesets/sources/` and move any other curated or project-specific sets into `genesets/custom/`.
