...
- `generate_kinases_from_biomart.R` — Kinases wrapper that runs the generic BioMart generator (InterPro + GO), writes temp outputs and union — inputs: Manning file, BioMart — outputs: `genesets/curated/kinases/kinases_human_union.csv` and temp files — `bin`
